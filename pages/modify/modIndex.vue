<template>
	<view class="page-wrap">
		...
		<view class="main-wrap">
			<!-- 待办业务列表 -->
			<mod-list ref="daibanref" v-show="currentNav==0" hideNav api=""></mod-list>
			<!-- 已办业务列表 -->
			<mod-list ref="yibanref" v-show="currentNav==1"  hideNav api=""></mod-list>
			<!-- 办结业务列表 -->
			<mod-list ref="banjieref" v-show="currentNav==2"  hideNav api=""></mod-list>
		</view>
	</view>
</template>

<script>
	import modList from '@/pages/modify/modList'
	export default {
		components:{modList},
		data() {
			return {
